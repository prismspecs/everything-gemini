...
- [Refresh] **Automatic OCR**: Tries multiple OCR methods (macOS Vision, EasyOCR, Tesseract)
- [Doc] **Bilingual PDF**: Original image + professional English translation
- [World] **Multi-language**: Supports Chinese, and other languages
- [Clipboard] **Professional Format**: Suitable for official visa applications
- [Feature] **Fully Automated**: No manual intervention required
