...
Detailed guidelines are in `~/.gemini/rules/`. You can import them directly into your context using the `@` symbol:

```markdown
@~/.gemini/rules/common/security.md
@~/.gemini/rules/common/coding-style.md
@~/.gemini/rules/common/testing.md
@~/.gemini/rules/common/git-workflow.md
@~/.gemini/rules/common/agents.md
@~/.gemini/rules/common/patterns.md
@~/.gemini/rules/common/performance.md
```
